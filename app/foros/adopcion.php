...
$total_pages_sql = "SELECT COUNT(*) FROM foros WHERE foro='adopcion' AND idlocalidad = $idl";
...
WHERE f.foro = 'adopcion' AND f.idlocalidad=$idl AND f.borrado='n'
...
<?php require("../include/_header.php");?>
    <main>
        <section>
                ...
                <tbody>
                    <?php while($registros = mysqli_fetch_assoc($meperdi)):?>
                        <tr class='Publicacion'>
                            ...
                            <td><?= $registros["nombre"]?>-<?= $registros["raza"]?>-<?= $registros["sexo"]?></td>
                            <td><?= $registros["nota"]?></td>
                            <td><a href='ver-publicacion.php?f=adopcion&idf=<?=$registros["idforo"]?>'>Entrar</a></td>
                        </tr>
                    <?php endwhile;?>  
                </tbody>
            </table>
            ...
            <?php else:?> 
                <h3>Vaya... ¡Qué bien!¡Están todas las mascotas felices!</h3>
                <br>
