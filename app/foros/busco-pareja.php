...
WHERE f.foro = 'busco-pareja' AND f.idlocalidad=$idl AND f.borrado='n'
...
<?php require("../include/_header.php");?>
    <main>
        <section>
            <a href="./provincia.php?foro=busco-pareja" class='Volver'>Volver</a>
            <h2>Foro busco pareja</h2>
                ...
                <tbody>
                    <?php while($registros = mysqli_fetch_assoc($meperdi)):?>
                        <tr class='Publicacion'>
                            ...
                            <td><a href='ver-publicacion.php?f=busco-pareja&idf=<?=$registros["idforo"]?>'>Entrar</a></td>
                        </tr>
                    <?php endwhile;?>  
                </tbody>
            </table>
            ...
            <?php else:?> 
                <h3>Vaya... ¡No hay nadie buscando pareja!</h3>
                <br>
